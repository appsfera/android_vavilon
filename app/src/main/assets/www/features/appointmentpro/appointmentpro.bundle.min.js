angular.module('starter').controller('AppointmentproHomeController',function(Dialog,Loader,Application,$ionicSideMenuDelegate,Customer,$session,Modal,$ionicScrollDelegate,$timeout,$ionicActionSheet,$filter,$ionicHistory,$translate,$rootScope,$ionicModal,Appointmentpro,Location,$scope,$state,$stateParams,$controller){angular.extend(this,$controller('AppointmentproCommanController',{Dialog:Dialog,$rootScope:$rootScope,$scope:$scope,$stateParams:$stateParams,Appointmentpro:Appointmentpro}));$scope.value_id=Appointmentpro.value_id=$stateParams.value_id;$scope.widget=Appointmentpro.widget=$stateParams.widget;$scope.settings=Appointmentpro.getAppointmentproSettings();Appointmentpro.cart={};$scope.managerBoking=[];$scope.payout={};$scope.postParams={};$scope.activeTab='about';$scope.action={tab:'today'};$scope.can_load_older_manager_booking=!0;if(Appointmentpro.widget!==null&&Appointmentpro.widget=='213848'){$ionicSideMenuDelegate.canDragContent(!1)}
$scope.findLocationInfo=function(){$scope.is_loading=!0;Appointmentpro.findLocationInfo($scope.payout.single_location_id).success(function(data){$scope.location_info=data.location;$scope.is_loading=!1}).error(function(error){$scope.is_loading=!1;Dialog.alert($translate.instant("Error","appointmentpro"),error.message,"OK",-1,"appointmentpro")}).finally(function(){$scope.$broadcast('scroll.infiniteScrollComplete')})};$scope.loadContent=function(){$scope.managerBoking=[];$scope.is_loading=!0;$scope.postParams.tab=$scope.action.tab;$scope.postParams.offset=0;Appointmentpro.findAll($scope.postParams).success(function(data){$scope.page_title=data.page_title;$scope.payout=data;$scope.settings=data.settings;Appointmentpro.setAppointmentproSettings(data.settings);Appointmentpro.setLabels(data.labels);if(data.is_single_location){$scope.findLocationInfo()}else{$scope.is_loading=!1}
if($scope.payout.settings.providerInfo.is_provider_layout){$scope.sub_title=data.sub_title;$scope.can_load_older_manager_booking=!!data.bookingJson.length;$scope.managerBoking=$scope.managerBoking.concat(data.bookingJson)}}).error(function(error){$scope.is_loading=!1;Dialog.alert($translate.instant("Error","appointmentpro"),error.message,"OK",-1,"appointmentpro")}).finally(function(){$scope.$broadcast('scroll.infiniteScrollComplete')})};$scope.getLocation=function(){if(Location.isEnabled&&$scope.settings.default_location_sorting==='distance'){Location.getLocation({timeout:10000},!0).then(function(position){$scope.postParams.latitude=position.coords.latitude;$scope.postParams.longitude=position.coords.longitude;$scope.loadContent()},function(){$scope.postParams.latitude='';$scope.postParams.longitude='';$scope.requestLocation()})}else{$scope.postParams.latitude='';$scope.postParams.longitude='';if($scope.settings.default_location_sorting==='distance'){$scope.requestLocation()}
$scope.loadContent()}}
$scope.requestLocation=function(){Location.requestLocation(function(){$scope.loadContent()},function(){$scope.loadContent()})}
$scope.$on("$ionicView.beforeEnter",function(event,data){$scope.getLocation()});$scope.loadManagerBooking=function(){$scope.loadContent()}
$scope.loadMoreManagerBooking=function(){if(!$scope.managerBoking.length){return!1}
$scope.postParams.offset=$scope.managerBoking.length;Appointmentpro.findAll($scope.postParams).success(function(data){$scope.can_load_older_manager_booking=!!data.bookingJson.length;$scope.managerBoking=$scope.managerBoking.concat(data.bookingJson)}).error(function(error){$scope.can_load_older_manager_booking=!1;Dialog.alert($translate.instant("Error","appointmentpro"),error.message,"OK",-1,"appointmentpro")}).finally(function(){$scope.$broadcast('scroll.infiniteScrollComplete')})};$scope.login=function(){if(!Customer.isLoggedIn()){Customer.loginModal($scope,function(){$timeout(function(){$scope.is_logged_in=Customer.isLoggedIn();$scope.customer=Customer.customer;$state.go('home').then(function(){$state.go("appointmentpro-home",{value_id:$scope.value_id},{reload:!0})})},1000)})}else{Customer.loginModal()}}
...
$scope.closeModalLocationService();$scope.cart=Appointmentpro.cart;$scope.cart.location_id=$scope.location_info.location_id;$scope.cart.category_id=service.category_id;$scope.cart.service_id=service.service_id;Appointmentpro.cart=$scope.cart;$state.go("appointmentpro-provider",{value_id:$scope.value_id,service_id:service.service_id},{reload:!0})};$scope.updateStatus=function(bookingId,Status,bookingIndex){Loader.show();Appointmentpro.updateStatus(bookingId,Status).success(function(data){$scope.managerBoking[bookingIndex]=data.booking;Loader.hide()}).error(function(error){Loader.hide();Dialog.alert($translate.instant("Error","appointmentpro"),error.message,"OK",-1,"appointmentpro")})};$scope.actionManagerBooking=function(booking,bookingIndex){console.log('bookingIndex',bookingIndex);var buttonIndexing=[];var buttonPositon=0;var sheetButtons=[];sheetButtons[buttonPositon]={text:$translate.instant("View",'appointmentpro')};buttonIndexing[buttonPositon]='view';buttonPositon=buttonPositon+1;if(!booking.is_accepted_hide&&!booking.is_completed_hide&&!booking.is_rejected_hide){sheetButtons[buttonPositon]={text:$translate.instant("Accept",'appointmentpro')};buttonIndexing[buttonPositon]='accept';buttonPositon=buttonPositon+1}
if(!booking.is_accepted_hide&&!booking.is_completed_hide&&!booking.is_rejected_hide){sheetButtons[buttonPositon]={text:$translate.instant("Reject",'appointmentpro')};buttonIndexing[buttonPositon]='reject';buttonPositon=buttonPositon+1}
if(!booking.is_rejected_accepted_action&&!booking.is_completed_hide&&!booking.is_rejected_hide){sheetButtons[buttonPositon]={text:$translate.instant("Mark As Complete",'appointmentpro')};buttonIndexing[buttonPositon]='mark_as_complete';buttonPositon=buttonPositon+1}
if(!booking.is_rejected_accepted_action&&!booking.is_completed_hide&&!booking.is_rejected_hide){sheetButtons[buttonPositon]={text:$translate.instant("Cancel",'appointmentpro')};buttonIndexing[buttonPositon]='cancel';buttonPositon=buttonPositon+1}
if(!booking.is_completed_hide){sheetButtons[buttonPositon]={text:$translate.instant("Delete",'appointmentpro')};buttonIndexing[buttonPositon]='delete';buttonPositon=buttonPositon+1}
var hideSheet=$ionicActionSheet.show({buttons:sheetButtons,cancelText:$translate.instant("Dismiss","appointmentpro"),titleText:$translate.instant("Booking Actions","appointmentpro"),cancel:function(){hideSheet()},buttonClicked:function(index){if(buttonIndexing[index]=="view"){$scope.bookingDetailsById(booking.appointment_id)}
if(buttonIndexing[index]=="accept"){$scope.updateStatus(booking.appointment_id,3,bookingIndex)}
if(buttonIndexing[index]=="reject"){$scope.updateStatus(booking.appointment_id,8,bookingIndex)}
if(buttonIndexing[index]=="mark_as_complete"){$scope.updateStatus(booking.appointment_id,4,bookingIndex)}
if(buttonIndexing[index]=="cancel"){$scope.updateStatus(booking.appointment_id,6,bookingIndex)}
if(buttonIndexing[index]=="delete"){$scope.updateStatus(booking.appointment_id,'delete',bookingIndex)}
return!0}})}
$scope.bookingDetailsById=function(booking_id){$scope.is_loading_modal=!0;Loader.show();$ionicModal.fromTemplateUrl('features/appointmentpro/assets/templates/l1/manager/modal/booking_detail.html',{scope:$scope,animation:'slide-in-right-left'}).then(function(modal){Appointmentpro.findBookingDetailsById(booking_id).success(function(data){$scope.booking_info=data.booking;Loader.hide();$scope.is_loading_modal=!1}).error(function(error){Loader.hide();$scope.is_loading_modal=!1;Dialog.alert($translate.instant("Error","appointmentpro"),error.message,"OK",-1,"appointmentpro");$scope.closeModalBookingDetails()});$scope.modalBookingDetails=modal;$scope.modalBookingDetails.show()})};$scope.closeModalBookingDetails=function(){$scope.modalBookingDetails.remove()}});angular.module('starter').controller('AppointmentproCommanController',function($rootScope,SB,$scope,$stateParams,$state,$translate,Loader,$timeout,Appointmentpro,$ionicModal,Customer,$ionicActionSheet){$scope.settings=Appointmentpro.getAppointmentproSettings();$scope.value_id=Appointmentpro.value_id=$stateParams.value_id;$scope.forTranslate=function(text){return $translate.instant(text,"appointmentpro")};$scope.getLabelName=function(key){$scope.labels=Appointmentpro.getLabels();return $translate.instant($scope.labels[key],"appointmentpro")};$scope.appointmentproSliderImage=function(image){if(image!=''&&image!=null&&image!="null"){return IMAGE_URL+'images/application'+image}else{return"./features/appointmentpro/assets/media/default-image.png"}};$scope.appointmentproImage=function(image){if(image!=''&&image!=null&&image!="null"&&image!='0'){return IMAGE_URL+'images/application'+image}else{return"./features/appointmentpro/assets/media/customer-placeholder.png"}};$scope.classDetails=function(service_id){$scope.is_loading_modal=!0;Loader.show();$ionicModal.fromTemplateUrl('features/appointmentpro/assets/templates/modal/classes/details.html',{scope:$scope,animation:'slide-in-right-left'}).then(function(modal){Appointmentpro.getClassInfo(service_id).success(function(data){$scope.class_info=data.class;Loader.hide();$scope.is_loading_modal=!1}).error(function(error){Loader.hide();$scope.is_loading_modal=!1;Dialog.alert($translate.instant("Error","appointmentpro"),error.message,"OK",-1,"appointmentpro")});$scope.modalclassDetails=modal;$scope.modalclassDetails.show()})};$scope.closeModalClassDetails=function(){$scope.modalclassDetails.remove()}
...
Appointmentpro.cart=$scope.cart;Loader.show();Appointmentpro.bookingSubmit($scope.cart).then(function(data){Loader.hide();if(data.is_paypal&&data.booking_status){$scope.cart.booking_id=data.booking_id;$scope.cart.paypal_url=data.paypalURL;Appointmentpro.set_local('PAYPAL_BEFORE_DATA',JSON.stringify($scope.cart));$scope.populateURL($scope.cart)}else{if(data.is_payfast){$scope.cart.booking_id=data.booking_id;Appointmentpro.set_local('PAYFAST_BEFORE_DATA',JSON.stringify($scope.cart));$scope.responsePayfast=data.responsePayfast;var form=document.createElement("form");form.setAttribute("method",'post');form.setAttribute("action",$scope.responsePayfast.action_url);form.setAttribute("target","formresult");var fields=$scope.responsePayfast.fields;for(var key in fields){var hiddenField=document.createElement("input");hiddenField.setAttribute("type","hidden");hiddenField.setAttribute("name",fields[key].name);hiddenField.setAttribute("value",fields[key].value);form.appendChild(hiddenField)}
if(!Application.is_webview){function popitup(){var browser=$window.open('/','formresult','location=yes');$timeout(function(){browser.document.body.appendChild(form);browser.document.form.submit();return!1},1000)}
popitup();browser.addEventListener('loadstart',function(event){if(/(mobile_paypalreturn)/.test(event.url)){browser.close();$state.go("home").then(function(){$state.go("appointmentpro-home",{value_id:$scope.value_id},{reload:!0}).then(function(){Loader.hide();$state.go("appointmentpro-booked-success",{value_id:$scope.value_id,booking_id:$scope.cart.booking_id},{reload:!0})})})}})}else{document.body.appendChild(form);form.submit()}}else{if(!data.booking_status){Dialog.alert($translate.instant("Error","appointmentpro"),data.message,$translate.instant("OK","appointmentpro"))}else{Dialog.alert($translate.instant("Success","appointmentpro"),data.message,$translate.instant("OK","appointmentpro"))}
...
Application.loaded.then(function(){Loader.show();$scope.loadContent()})}).controller('AppointmentproPayfastReturnController',function(Dialog,Appointmentpro,SB,$ionicHistory,$ionicLoading,$location,Application,$ionicPlatform,$rootScope,$ionicScrollDelegate,Loader,$timeout,$ionicSlideBoxDelegate,Customer,$scope,$filter,$state,$stateParams,$translate,$ionicModal){$scope.value_id=Appointmentpro.value_id=$stateParams.value_id;Appointmentpro.cart=JSON.parse(Appointmentpro.get_local('PAYFAST_BEFORE_DATA'));Appointmentpro.unset_local('PAYFAST_BEFORE_DATA');$scope.cart=Appointmentpro.cart;Loader.show();$scope.loadContent=function(){var booking_id=$scope.cart.booking_id;Loader.show();console.log("loadContent return");$state.go("home").then(function(){console.log("go to appointmentpro home");$state.go("appointmentpro-home",{value_id:$scope.value_id},{reload:!0}).then(function(){Loader.hide();console.log("go to appointmentpro successfully");$state.go("appointmentpro-booked-success",{value_id:$scope.value_id,booking_id:booking_id},{reload:!0})})})}
Application.loaded.then(function(){Loader.show();$timeout(function(){$scope.loadContent()},1500)})});angular.module('starter').controller('AppointmentproSuccessController',function(Dialog,Loader,$controller,Application,Customer,$session,Modal,$timeout,$translate,$rootScope,Appointmentpro,$scope,$state,$stateParams){angular.extend(this,$controller('AppointmentproCommanController',{Dialog:Dialog,$rootScope:$rootScope,$scope:$scope,$stateParams:$stateParams,Appointmentpro:Appointmentpro}));$scope.value_id=Appointmentpro.value_id=$stateParams.value_id;$scope.settings=Appointmentpro.getAppointmentproSettings();$scope.booking_id=$stateParams.booking_id;$scope.payout={};$scope.service_type='services';$scope.loadContent=function(){$scope.is_loading=!0;Appointmentpro.bookingDetails($scope.booking_id).success(function(data){$scope.payout=data;if($scope.payout.booking.is_it_class==1){$scope.service_type='classes'}
...
$scope.requestLocation=function(){Location.requestLocation(function(){$scope.loadContent()},function(){$scope.loadContent()})}
$scope.$on("$ionicView.beforeEnter",function(event,data){$scope.getLocation()})}).controller('AppointmentproBookAClassController',function(Dialog,Loader,Application,$ionicSideMenuDelegate,Customer,$session,Modal,$ionicScrollDelegate,$timeout,$ionicModal,SB,$translate,$rootScope,Appointmentpro,$ionicPopup,$scope,$state,$stateParams,$controller,$compile){angular.extend(this,$controller('AppointmentproCommanController',{Dialog:Dialog,$rootScope:$rootScope,$scope:$scope,$stateParams:$stateParams,Appointmentpro:Appointmentpro}));$scope.value_id=Appointmentpro.value_id=$stateParams.value_id;$scope.cart=Appointmentpro.cart;$scope.settings=Appointmentpro.getAppointmentproSettings()});angular.module('starter').controller('AppointmentproManagerBookingController',function(Dialog,Loader,Application,$ionicSideMenuDelegate,Customer,$session,Modal,$ionicScrollDelegate,$timeout,$ionicActionSheet,$filter,$ionicHistory,$translate,$rootScope,$ionicModal,Appointmentpro,Location,$scope,$state,$stateParams,$controller){angular.extend(this,$controller('AppointmentproCommanController',{Dialog:Dialog,$rootScope:$rootScope,$scope:$scope,$stateParams:$stateParams,Appointmentpro:Appointmentpro}));$scope.value_id=Appointmentpro.value_id=$stateParams.value_id;$scope.tab=$stateParams.tab;$scope.service_type=$stateParams.service_type;$scope.settings=Appointmentpro.getAppointmentproSettings();$scope.managerBoking=[];$scope.payout={};$scope.postParams={};$scope.page_title=$translate.instant("Bookings","appointmentpro");$scope.can_load_older_manager_booking=!0;$scope.loadContent=function(){$scope.managerBoking=[];$scope.is_loading=!0;$scope.postParams.tab=$scope.tab;$scope.postParams.offset=0;$scope.postParams.service_type=$scope.service_type;Appointmentpro.findManagerBooking($scope.postParams).success(function(data){$scope.payout=data;$scope.can_load_older_manager_booking=!!data.bookings.length;$scope.managerBoking=data.bookings;$scope.is_loading=!1}).error(function(error){$scope.is_loading=!1;Dialog.alert($translate.instant("Error","appointmentpro"),error.message,"OK",-1,"appointmentpro")}).finally(function(){$scope.$broadcast('scroll.infiniteScrollComplete')})};$scope.loadContent();$scope.loadMoreManagerBooking=function(){if(!$scope.managerBoking.length){return!1}
$scope.postParams.offset=$scope.managerBoking.length;Appointmentpro.findManagerBooking($scope.postParams).success(function(data){$scope.can_load_older_manager_booking=!!data.bookings.length;$scope.managerBoking=$scope.managerBoking.concat(data.bookings)}).error(function(error){$scope.can_load_older_manager_booking=!1;Dialog.alert($translate.instant("Error","appointmentpro"),error.message,"OK",-1,"appointmentpro")}).finally(function(){$scope.$broadcast('scroll.infiniteScrollComplete')})};$scope.loadSearchBooking=function(){$timeout(function(){$scope.managerBoking=[];$scope.postParams.search=document.getElementById("bookingSearch").value;$scope.loadContent()},1000)}
$scope.updateStatus=function(bookingId,Status,bookingIndex){Loader.show();Appointmentpro.updateStatus(bookingId,Status).success(function(data){$scope.managerBoking[bookingIndex]=data.booking;Loader.hide()}).error(function(error){Loader.hide();Dialog.alert($translate.instant("Error","appointmentpro"),error.message,"OK",-1,"appointmentpro")})};$scope.actionManagerBooking=function(booking,bookingIndex){console.log('bookingIndex',bookingIndex);var buttonIndexing=[];var buttonPositon=0;var sheetButtons=[];sheetButtons[buttonPositon]={text:$translate.instant("View",'appointmentpro')};buttonIndexing[buttonPositon]='view';buttonPositon=buttonPositon+1;if(!booking.is_accepted_hide&&!booking.is_completed_hide&&!booking.is_rejected_hide){sheetButtons[buttonPositon]={text:$translate.instant("Accept",'appointmentpro')};buttonIndexing[buttonPositon]='accept';buttonPositon=buttonPositon+1}
if(!booking.is_accepted_hide&&!booking.is_completed_hide&&!booking.is_rejected_hide){sheetButtons[buttonPositon]={text:$translate.instant("Reject",'appointmentpro')};buttonIndexing[buttonPositon]='reject';buttonPositon=buttonPositon+1}
if(!booking.is_rejected_accepted_action&&!booking.is_completed_hide&&!booking.is_rejected_hide){sheetButtons[buttonPositon]={text:$translate.instant("Mark As Complete",'appointmentpro')};buttonIndexing[buttonPositon]='mark_as_complete';buttonPositon=buttonPositon+1}
if(!booking.is_rejected_accepted_action&&!booking.is_completed_hide&&!booking.is_rejected_hide){sheetButtons[buttonPositon]={text:$translate.instant("Cancel",'appointmentpro')};buttonIndexing[buttonPositon]='cancel';buttonPositon=buttonPositon+1}
if(!booking.is_completed_hide){sheetButtons[buttonPositon]={text:$translate.instant("Delete",'appointmentpro')};buttonIndexing[buttonPositon]='delete';buttonPositon=buttonPositon+1}
...
if(buttonIndexing[index]=="delete"){$scope.updateStatus(booking.appointment_id,'delete',bookingIndex)}
return!0}})}
$scope.bookingDetailsById=function(booking_id){$scope.is_loading_modal=!0;Loader.show();$ionicModal.fromTemplateUrl('features/appointmentpro/assets/templates/l1/manager/modal/booking_detail.html',{scope:$scope,animation:'slide-in-right-left'}).then(function(modal){Appointmentpro.findBookingDetailsById(booking_id).success(function(data){$scope.booking_info=data.booking;Loader.hide();$scope.is_loading_modal=!1}).error(function(error){Loader.hide();$scope.is_loading_modal=!1;Dialog.alert($translate.instant("Error","appointmentpro"),error.message,"OK",-1,"appointmentpro");$scope.closeModalBookingDetails()});$scope.modalBookingDetails=modal;$scope.modalBookingDetails.show()})};$scope.closeModalBookingDetails=function(){$scope.modalBookingDetails.remove()}});angular.module('starter').controller('AppointmentproManagerCustomersController',function(Dialog,Loader,Application,$ionicSideMenuDelegate,Customer,$session,Modal,$ionicScrollDelegate,$timeout,$ionicActionSheet,$filter,$ionicHistory,$translate,$rootScope,$ionicModal,Appointmentpro,Location,$scope,$state,$stateParams,$controller,LinkService){angular.extend(this,$controller('AppointmentproCommanController',{Dialog:Dialog,$rootScope:$rootScope,$scope:$scope,$stateParams:$stateParams,Appointmentpro:Appointmentpro}));$scope.value_id=Appointmentpro.value_id=$stateParams.value_id;$scope.settings=Appointmentpro.getAppointmentproSettings();$scope.managerCustomers=[];$scope.payout={search_text:'',};$scope.postParams={};$scope.page_title=$translate.instant("Customers","appointmentpro");$scope.can_load_older_manager_customers=!0;$scope.loadContent=function(){$scope.managerCustomers=[];$scope.is_loading=!0;$scope.postParams.offset=0;Appointmentpro.findManagerCustomers($scope.postParams).success(function(data){$scope.payout=data;$scope.can_load_older_manager_customers=!!data.customers.length;$scope.managerCustomers=data.customers;$scope.is_loading=!1}).error(function(error){$scope.is_loading=!1;Dialog.alert($translate.instant("Error","appointmentpro"),error.message,"OK",-1,"appointmentpro")}).finally(function(){$scope.$broadcast('scroll.infiniteScrollComplete')})};$scope.loadContent();$scope.isMobileNumber=function(mobile_number){if(mobile_number==''){return!1}
return!0}
$scope.customer_avatar=function(image){if(image!==''&&image!=null&&image!=='null'){return IMAGE_URL+'images/customer'+image}
return'./features/emenu/assets/media/customer-placeholder.png'};$scope.call=function(phone){LinkService.openLink("tel:"+phone,{},!0)};$scope.loadSearchContent=function(){$timeout(function(){$scope.managerCustomers=[];$scope.postParams.serach=document.getElementById("customerSearch").value;$scope.loadContent()},1000)}
$scope.loadMoreManagerCustomer=function(){if(!$scope.managerCustomers.length){return!1}
$scope.postParams.offset=$scope.managerCustomers.length;Appointmentpro.findManagerCustomers($scope.postParams).success(function(data){$scope.can_load_older_manager_customers=!!data.customers.length;$scope.managerCustomers=$scope.managerCustomers.concat(data.customers)}).error(function(error){$scope.can_load_older_manager_customers=!1;Dialog.alert($translate.instant("Error","appointmentpro"),error.message,"OK",-1,"appointmentpro")}).finally(function(){$scope.$broadcast('scroll.infiniteScrollComplete')})}});angular.module('starter').controller('AppointmentproManagerController',function(Dialog,Loader,Application,Customer,Modal,$timeout,$filter,$translate,Appointmentpro,$scope,$state,$stateParams,LinkService){$scope.value_id=Appointmentpro.value_id=$stateParams.value_id;$scope.settings=Appointmentpro.getAppointmentproSettings();$scope.loadContent=function(){$scope.is_loading=!0;Appointmentpro.managerProfile().success(function(data){$scope.payout=data;$scope.profile=data.profile;$scope.is_loading=!1}).error(function(error){$scope.is_loading=!1;Dialog.alert($translate.instant("Error","appointmentpro"),error.message,"OK",-1,"appointmentpro")}).finally(function(){$scope.$broadcast('scroll.infiniteScrollComplete')})};$scope.loadContent();$scope.profileSave=function(){Loader.show();Appointmentpro.profileSave($scope.profile).success(function(data){Loader.hide();Dialog.alert($translate.instant("Success","appointmentpro"),data.message,"OK",-1,"appointmentpro")}).error(function(error){Loader.hide();Dialog.alert($translate.instant("Error","appointmentpro"),error.message,"OK",-1,"appointmentpro")})}}).controller('AppointmentproManagerLocationController',function(Dialog,Loader,Application,Customer,Modal,$timeout,$filter,$translate,Appointmentpro,$scope,$state,$stateParams,LinkService){$scope.value_id=Appointmentpro.value_id=$stateParams.value_id;$scope.settings=Appointmentpro.getAppointmentproSettings();$scope.loadContent=function(){$scope.is_loading=!0;Appointmentpro.managerLocation().success(function(data){$scope.payout=data;$scope.location=data.location;$scope.is_loading=!1}).error(function(error){$scope.is_loading=!1;Dialog.alert($translate.instant("Error","appointmentpro"),error.message,"OK",-1,"appointmentpro")}).finally(function(){$scope.$broadcast('scroll.infiniteScrollComplete')})};$scope.loadContent();$scope.locationSave=function(){Loader.show();Appointmentpro.locationSave($scope.location).success(function(data){Loader.hide();Dialog.alert($translate.instant("Success","appointmentpro"),data.message,"OK",-1,"appointmentpro")}).error(function(error){Loader.hide();Dialog.alert($translate.instant("Error","appointmentpro"),error.message,"OK",-1,"appointmentpro")})}});angular.module('starter').factory('Appointmentpro',function(Url,$rootScope,$pwaRequest,$session,$sbhttp,$q,Application,$location,$window){var factory={value_id:null,widget:null,cart:{},StripeInstance:null,publishable_key:null,settings:[],labels:[],isReadyPromise:$q.defer()};factory.setValueId=function(valueId){factory.value_id=valueId;return factory};factory.getValueId=function(){return factory.value_id};factory.isUndefined=function(thing){return(typeof thing==="undefined")}
